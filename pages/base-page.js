...
exports.BasePage = class BasePage {
  ...
  async dataLayerReady() {
     ...
     */
    await this.page.waitForFunction(() => window.appEventData && Array.isArray(window.appEventData) && window.appEventData.computedState);
  }
  ...
  async getDataLayer() {
     ...
     */
    return await this.page.evaluate(() => window.appEventData.computedState);
  }
